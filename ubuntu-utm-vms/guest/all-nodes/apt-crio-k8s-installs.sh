...
apt install inetutils-traceroute net-tools parted lvm2 netcat-openbsd zip git apt-transport-https ca-certificates curl gnupg2 software-properties-common jo jq yq linux-modules-extra-$(uname -r) -y
